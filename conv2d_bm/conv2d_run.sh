...
ZCU_PATH="../zcu_apps/"
COMPILER_SCRIPT="./conv2d_compiler.sh"
...
python conv2d_model.py || print_err "conv2d_model.py failed"
print_ok "All model generated."

print_info "Running model inspecting..."
python conv2d_inspector.py || print_err "conv2d_inspector.py failed"
print_ok "Model inspecting finished."

print_info "Running model quantizing..."
python conv2d_quantizer.py || print_err "conv2d_quantizer.py failed"
rm -rf $INSPECT_PATH
rm -rf $WEIGHT_PATH
