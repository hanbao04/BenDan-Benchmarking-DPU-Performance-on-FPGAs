...
ZCU_PATH="../zcu_apps/"
COMPILER_SCRIPT="./depthwise_compiler.sh"
...
python depthwise_model.py || print_err "depthwise_model.py failed"
print_ok "All model generated."

print_info "Running model inspecting..."
python depthwise_inspector.py || print_err "depthwise_inspector.py failed"
print_ok "Model inspecting finished."

print_info "Running model quantizing..."
python depthwise_quantizer.py || print_err "depthwise_quantizer.py failed"
rm -rf $INSPECT_PATH
rm -rf $WEIGHT_PATH
