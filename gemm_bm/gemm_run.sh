...
ZCU_PATH="../zcu_apps/"
COMPILER_SCRIPT="./gemm_compiler.sh"
...
python gemm_model.py || print_err "gemm_model.py failed"
print_ok "All model generated."

print_info "Running model inspecting..."
python gemm_inspector.py || print_err "gemm_inspector.py failed"
print_ok "Model inspecting finished."

print_info "Running model quantizing..."
python gemm_quantizer.py || print_err "gemm_quantizer.py failed"
rm -rf $INSPECT_PATH
rm -rf $WEIGHT_PATH
